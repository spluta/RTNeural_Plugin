...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 70.0, 433.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 193.5, 352.0, 29.5, 22.0 ],
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 321.0, 156.0, 365.0, 20.0 ],
					"text" : "loads an lstm model which takes 2 inputs - 1) audio, 2) gain knob"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 387.0, 372.0, 130.0, 130.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 202.0, 317.0, 74.0, 22.0 ],
					"text" : "mc.unpack~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 202.0, 433.0, 45.0, 45.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 202.0, 386.0, 130.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 252.0, 211.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 252.0, 27.0, 20.0, 140.0 ],
					"size" : 1.0
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 202.0, 241.0, 70.0, 22.0 ],
					"text" : "mc.pack~ 2"
				}
