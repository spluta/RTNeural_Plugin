...
if (APPLE)
	...
	target_link_libraries(${PROJECT_NAME}  ${MSP_LIBRARY})
	find_library(
	...
	target_link_libraries(${PROJECT_NAME}  ${JITTER_LIBRARY})
...
elseif (WIN32)
	...
	if (EXCLUDE_FROM_COLLECTIVES STREQUAL "yes")
		target_compile_definitions(${PROJECT_NAME}  "-DEXCLUDE_FROM_COLLECTIVES")
	endif()

	if (ADD_VERINFO)
		target_sources(${PROJECT_NAME}  ${CMAKE_CURRENT_LIST_DIR}/verinfo.rc)
	endif()
endif ()
